...
const fromEncoded = (encoded: string): AbiSwapTransition => {
  ...
  return new AbiSwapTransition(decoded[0], decoded[1], decoded[2], + decoded[3], decoded[4], decoded[5], decoded[6], decoded[7])
}
...
export class AbiSwapTransition implements AbiEncodable {
  public static abiTypes = ['bytes32', 'uint32', 'uint32', 'bool', 'uint32', 'uint32', 'uint', 'bytes']
